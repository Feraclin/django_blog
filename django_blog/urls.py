...
from blog.views import UserListView, PostsView, UserSubscriptionsView, SubscriptionView, ProfileView, \
...
urlpatterns = [
    ...
    path('api/v1/subscription/', UserSubscriptionsView.as_view()),
